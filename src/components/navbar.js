...
export default function Nav(){
    ...
    <div> 
      <ol className="flex bg-[#3D3D3D] w-screen h-12 text-center items-center" >
        ...
        <li className="flex-1 border-l-2 "><ActiveLink href={"/teams"}>Teams</ActiveLink></li>
        <li className="flex-1 align-middle border-l-2"><ActiveLink href={"/"}>Home</ActiveLink></li>
